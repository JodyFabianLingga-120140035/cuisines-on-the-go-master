...
const initialValues = {phone_number:'',name:"",family_name:"",username:''}
  ...
  return(
      <View style = {styles.container}>
          ...
          <ScrollView keyboardShouldPersistTaps = "always">
              ...
              <Formik initialValues = {initialValues} onSubmit = {(values) => {RegisterScreen(values)}}>
                  {(props)=>(
                        <View style = {styles.view2}>
                            <View>
                                <Text style = {styles.text2}>New on Cuisines ?</Text>
                            </View>
              ...
              <View style = {styles.view18}>
                ...
                <View style ={styles.view19}>
                    <View style ={styles.view20}>
                        <Text style ={styles.text6}>Already have an account with cuisiness on the go ?</Text>
                    </View>
